...
class ProjectAdd(AbstractCommand):
    ...
    description = "Run: 'proco project add . default' to add actual directory to default catalog."
    ...
    def resolve_dependencies(self):
        ...
        file_name = FileUtils.get_backward_compatible_proco_file(self.target_dir, True)
