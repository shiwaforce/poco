...
class CatalogHandler:
    ...
    def get_url(config):
        ...
        return EnvironmentUtils.get_variable('PROCO_CATALOG')
    ...
    def get_catalog_file(config):
        ...
        if config is not None:
            ...
            return config.get('file', 'proco-catalog.yml')
        return None
    ...
    def print_ls():
        ...
        if not empty:
            ...
            ColorPrint.print_with_lvl(
                message="Project catalog is empty. You can add projects with 'proco repo add' command",
                lvl=-1)
